...
namespace SRP.Application.DTOs.Address.Validators
{
    public class IAddressDtoValidator : AbstractValidator<IAddressDto>
    {
        ...
        public IAddressDtoValidator(IAddressTypeRepository addressTypeRepository, ICountryRepository countryRepository, IProvinceRepository provinceRepository)
        {
            ...
            {
                bool tExists = await mAddressTypeRepository.Exists(addressTypeId);
                return !tExists;
            })
            ...
            RuleFor(p => p.ProvinceId)
                ...
                {
                    bool tExists = await mProvinceRepository.Exists(provinceId);
                    return !tExists;
                })
                .WithMessage("{PropertyName} is invalid.");
            ...
            RuleFor(p => p.CountryId)
                ...
                {
                    bool tExists = await mCountryRepository.Exists(countryId);
                    return !tExists;
                })
                .WithMessage("{PropertyName} is invalid.");
        }
